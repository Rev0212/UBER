      ...
      <img className='w-16 mb-10' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYQy-OIkA6In0fTvVwZADPmFFibjmszu2A0g&s" alt="Logo" />
        ...
        <form onSubmit={(e) => submitHandler(e)}>
          ...
          <div className='flex gap-4 mb-7'>
            ...
            <select
              required
              className='bg-[#eeeeee] w-1/2 rounded-lg px-4 py-2 border text-lg placeholder:text-base focus:border-[#111] focus:outline-none'
              value={vehicleType}
              onChange={(e) => setVehicleType(e.target.value)}
            >
              <option className='placeholder:text-base' value="" disabled>Vehicle Type</option>
